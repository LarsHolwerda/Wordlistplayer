...
public class AdapterRecyclerToView extends RecyclerView.Adapter<AdapterRecyclerToView.ViewHolder> {
    ...
    public AdapterRecyclerToView (ArrayList<AdapterRecyclerItem> dataSet, Context context, String filename) {
